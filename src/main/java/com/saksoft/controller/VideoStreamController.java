...
import com.saksoft.service.VideoStreamService;
...
public class VideoStreamController {
    ...
    @GetMapping("/stream/published/{fileType}/{fileName}")
    public String published(ServerHttpResponse serverHttpResponse, @RequestHeader(value = "Range", required = false) String httpRangeList,
            @PathVariable("fileType") String fileType,
            @PathVariable("fileName") String fileName) {
//    	ResponseEntity<byte[]> byteVideodata=videoStreamService.prepareContent(fileName, fileType, httpRangeList);
//        kafkaTemplate.send(TOPIC, byteVideodata);
